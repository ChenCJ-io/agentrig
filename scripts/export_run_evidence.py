"""Export a compact, secret-free run evidence bundle from the local API."""
...
def build_bundle(base_url: str, session_id: str | None) -> dict[str, Any]:
    ...
    return {
        "schema_version": "agentrig.run-evidence.v1",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path(".agentrig/evidence/run-evidence.json"),
    )
