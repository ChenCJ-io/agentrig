...
class IngestSourceORM(Base):
    ...
    gateway: Mapped[dict[str, Any] | None] = mapped_column(JSON)
...
class ProductionTraceORM(Base):
    ...
    input_full_redacted: Mapped[str | None] = mapped_column(Text)
    output_full_redacted: Mapped[str | None] = mapped_column(Text)
    attributes: Mapped[dict[str, Any]] = mapped_column(JSON, nullable=False, default=dict)
