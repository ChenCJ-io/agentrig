...
const OnboardingPage = lazy(() => import("~/pages/governance/onboarding-page").then((module) => ({ default: module.OnboardingPage })));
...
export function WorkspaceRouter() {
  ...
  if (pathname.startsWith("/onboarding")) return renderPage(<OnboardingPage />);
  if (
